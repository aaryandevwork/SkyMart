...
const ShopPage = () => {
  ...
  const { setSearch, setSortBy , selectedCategory , handleCategoryChange , finalProducts } = useProductFilter(products);
        ...
        <div className="grid lg:grid-cols-12 gap-5">
          ...
          <div className="lg:col-span-8 relative border border-white/15 rounded-2xl">
            ...
            <input
              ...
              className="bg-[#1d1d1d] rounded-2xl w-full text-white text-sm pl-14 pr-2 py-2 transition-all duration-300 focus:border-lime-400 focus:ring-4 focus:ring-lime-400/20 outline-none "
            />
          </div>
